                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Thamizh Selvan</b>
                          <b className="is-hidden">UI/UX Designer</b>
                          <b className="is-visible">UI Developer</b>
                        </span>
                      </h1>
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://www.linkedin.com/in/thamizh-selvan-ui-developer"
                              target="newtab"
                            >
                              <i
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                        UI Developer with 11+ years of experience in designing and developing responsive web templates, mobile applications, and Progressive Web Applications (PWAs). Expertise in converting Adobe XD and Figma designs into pixel-perfect, responsive HTML pages with strong focus on performance and usability. Skilled in Umbraco (v13+) CMS for template development, content structuring, and front-end customization. Currently enhancing skills in React.js to strengthen expertise in modern front-end frameworks.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="row love-row wow fadeIn">
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".1s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Hard-work in my profession</p>
                    </div>
                  </div>
                  <div className="col-md-3 col-sm-6">
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="love-details" data-wow-delay=".4s">
                      ...
                      <div className="underline1"></div>
                      <div className="underline2"></div>
                      <p>Created all modern web development.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="col-md-8 col-sm-6 col-xs-12 about-col">
                    <div className="about-details wow fadeIn">
                      <div className="main-title left-title text-left wow fadeIn">
                        <h3>Hi! I'm Thamizh Selvan</h3>
                        <div className="underline1 no-margin"></div>
                        <div className="underline2 no-margin"></div>
                      </div>
                      <p className="wow fadeIn">
                        I am a UI Developer with 11+ years of experience in building responsive, user-friendly web templates, mobile applications, and Progressive Web Applications (PWAs). I am skilled in HTML5, CSS3, JavaScript, jQuery, Bootstrap, Foundation, and Tailwind, with strong knowledge of WordPress and Umbraco v13 for backend integration. 
                        I specialize in converting Adobe XD, Figma, Photoshop (PSD), and Canva designs into pixel-perfect interfaces optimized for all devices. A quick learner with strong adaptability, I have also contributed to UX design and performance optimization. Currently, I am enhancing my skills in React.js to strengthen my expertise in modern front-end frameworks.
                      </p>
                      <a
                        className="about-link-1"
                        href="assets/cv/cv_of_Thamizh.pdf"
                        target="_blank"
                      >
                        See Resume
                      </a>
                  ...
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".2s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          10th Standard from <b>St, Andrews Higher Secondary School</b> with <b>63%</b> percentage. Arakkonam, Vellore (DT), Tamil Nadu. 
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".3s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          <b>D.C.E(CSE)</b> from <b>Sri Durga Devi Polytechnic College</b> with <b>87%</b> percentage. Kavarpet, Thiruvallur (DT), Tamil Nadu. 
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-4">
                    <div className="resume-details" data-wow-delay=".4s">
                      ...
                      <div className="resume-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          <b>B.E(CSE)</b> from <b>M.N.M Jain Engineering College</b> with <b>67%</b> percentage affiliated to Anna University, Chennai, Tamil Nadu.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-4 col-sm-12">
                    <div className="exp-details" data-wow-delay=".2s">
                      ...
                      <div className="exp-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Delivered pixel-perfect, responsive websites from PSD, Figma, and Adobe XD designs.
                          Practical experience in task runners and build tools such as Gulp, Node.js  .
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-12">
                    <div className="exp-details" data-wow-delay=".3s">
                      ...
                      <div className="exp-main">
                        ...
                        <h3>
                          <a
                            href="https://www.softwarecubes.com/"
                            target="_blank"
                            rel="noopener noreferrer"
                            style={{ color: "#4d4d4d" }}
                          >
                        ...
                        <div className="underline2"></div>
                        <p>
                          Responsive sites developed with Bootstrap. Develop and customize WordPress themes and Develop new Landing pages and web layouts. 
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-12">
                    <div className="exp-details" data-wow-delay=".4s">
                      ...
                      <div className="exp-main">
                        ...
                        <div className="underline2"></div>
                        <p>
                          Developed and maintained web sites. Create websites using Accelerated Mobile Pages (AMP) Specially for Blogs and Articles. Page Speed Optimization and SEO.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-4 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:leadinglimat@gmail.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
                    ...
                    <div className="col-md-4 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".6s">
                        ...
                        >
                          https://www.linkedin.com/in/thamizh-selvan-ui-developer
                        </a>
                      </div>
                    </div>
                  </div>
